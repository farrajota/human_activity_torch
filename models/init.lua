...
network_list['kps-convnet3d_2'] = paths.dofile('kps_convnet3d_2.lua')
network_list['kps-convnet3d_3'] = paths.dofile('kps_convnet3d_3.lua')
network_list['kps-convnet3d_4'] = paths.dofile('kps_convnet3d_4.lua')
network_list['vgg16-kps-convnet3d'] = paths.dofile('vgg16_kps_convnet3d.lua')
network_list['vgg16-kps-convnet3d_2'] = paths.dofile('vgg16_kps_convnet3d_2.lua')
