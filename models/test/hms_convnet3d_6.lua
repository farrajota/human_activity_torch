...
local function load_classifier_network(input_size, num_feats, num_activities, num_layers, seq_length)
    ...
    classifier:add(nn.VolumetricConvolution(input_size, 128, 7,7,7, 2,2,2, 3,3,3))  -- 64 -> 32
    ...
    classifier:add(nn.VolumetricConvolution(num_feats, num_activities, 2,4,4, 1,1,1, 0,0,0))
