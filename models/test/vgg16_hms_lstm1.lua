...
local function create_network()
    ...
    local loader_vgg16 = paths.dofile('vgg16_lstm.lua')
    local loader_hms = paths.dofile('hms_lstm.lua')

    local vgg16_features, _, vgg16_lstm, vgg16_params = loader_vgg16()
    local _, hms_features, hms_lstm, _ = loader_hms()
