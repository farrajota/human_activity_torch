...
local function Parse(arg)
    ...
    cmd:text()
    cmd:option('-expID',    'architectures-lstm-test9', 'Experiment ID')
    ...
    cmd:text()
    cmd:option('-netType',  'vgg16-hms-lstm-v1', 'Options: vgg16-lstm | hms-lstm | vgg16-hms-lstm | vgg16-convnet | hms-convnet | vgg16-hms-convnet.')
