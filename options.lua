...
local function Parse(arg)
    ...
    cmd:text()
    cmd:option('-expID',    'resnet-lstm-test6', 'Experiment ID')
    ...
    cmd:text()
    cmd:option('-netType',  'resnet18-lstm', 'Options: vgg16-lstm | hms-lstm | vgg16-hms-lstm | vgg16-convnet | hms-convnet | vgg16-hms-convnet.')
    ...
    cmd:option('-same_transform',  'true', 'Use the same transformations for all images of a sequence.')
    ...
    opt.same_transform = utils.Str2Bool(opt.same_transform)
