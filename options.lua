...
local function Parse(arg)
    ...
    cmd:text()
    cmd:option('-expID',    'test-resnet50-lstm', 'Experiment ID')
    ...
    cmd:text()
    cmd:option('-netType',  'resnet50-hms-lstm-v2', 'Options: vgg16-lstm | hms-lstm | vgg16-hms-lstm | vgg16-convnet | hms-convnet | vgg16-hms-convnet.')
    ...
    cmd:option('-heatmap_jit',          6, 'Jit the heatmaps by N pixels in the (x,y) coordinates.')
