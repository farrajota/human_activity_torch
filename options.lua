...
local function Parse(arg)
    ...
    cmd:text()
    cmd:option('-netType',  'vgg16-lstm', 'Options: vgg16-lstm | kps-lstm | vgg16-kps-lstm | vgg16-convnet | kps-convnet | vgg16-kps-convnet.')
    ...
    cmd:option('-test_load_best',   'false', 'Load the best accuracy network instead of the last snapshot.')
