...
local function Parse(arg)
    ...
    cmd:text()
    cmd:option('-expID',    'architecture-test9', 'Experiment ID')
    ...
    cmd:text()
    cmd:option('-netType',  'kps-convnet3d_3', 'Options: vgg16-lstm | kps-lstm | vgg16-kps-lstm | vgg16-convnet | kps-convnet | vgg16-kps-convnet.')
